...
public class ActivityChoosecityAdapterAdapter extends BaseAdapter {

    private List<Map<String, String>> objects = new ArrayList<>();
    private Context context;
    private LayoutInflater layoutInflater;

    public ActivityChoosecityAdapterAdapter(Context context, List<Map<String, String>> list) {
    ...
    private void initializeViews(Map<String, String> object, ViewHolder holder) {
        //TODO implement
        holder.choosecityAdapterTv.setText(object.get("hotcityname"));
